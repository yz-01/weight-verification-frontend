...
import CreateRoute from "@/app/(dashboard)/suppliers/create/page";

/**
 * `/suppliers/create` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalSupplierCreate() {
  return (
    <FormDialog>
      <CreateRoute />
    </FormDialog>
