...
import EditRoute from "@/app/(dashboard)/scales/[id]/edit/page";

/**
 * `/scales/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalScaleEdit(props: PageProps<"/scales/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
