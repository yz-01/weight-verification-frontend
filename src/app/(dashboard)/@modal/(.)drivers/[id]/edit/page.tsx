...
import EditRoute from "@/app/(dashboard)/drivers/[id]/edit/page";

/**
 * `/drivers/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalDriverEdit(props: PageProps<"/drivers/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
