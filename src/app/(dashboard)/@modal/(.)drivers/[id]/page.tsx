...
import DetailRoute from "@/app/(dashboard)/drivers/[id]/page";

/**
 * `/drivers/<id>` opened from inside the app (T-243).
 *
 ...
 * working.
 */
export default function ModalDriverDetail(
  props: PageProps<"/drivers/[id]">,
) {
  return (
    <DetailDialog>
      <DetailRoute {...props} />
