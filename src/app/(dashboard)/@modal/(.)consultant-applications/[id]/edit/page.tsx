...
import EditRoute from "@/app/(dashboard)/consultant-applications/[id]/edit/page";

/**
 * `/consultant-applications/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalConsultantApplicationEdit(props: PageProps<"/consultant-applications/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
