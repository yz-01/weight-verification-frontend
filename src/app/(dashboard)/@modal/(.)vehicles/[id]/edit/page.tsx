...
import EditRoute from "@/app/(dashboard)/vehicles/[id]/edit/page";

/**
 * `/vehicles/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalVehicleEdit(props: PageProps<"/vehicles/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
