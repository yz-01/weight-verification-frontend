...
import EditRoute from "@/app/(dashboard)/users/[id]/edit/page";

/**
 * `/users/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalUserEdit(props: PageProps<"/users/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
