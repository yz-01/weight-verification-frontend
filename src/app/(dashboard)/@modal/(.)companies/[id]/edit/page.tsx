...
import EditRoute from "@/app/(dashboard)/companies/[id]/edit/page";

/**
 * `/companies/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalCompanyEdit(props: PageProps<"/companies/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
