...
import CreateRoute from "@/app/(dashboard)/companies/create/page";

/**
 * `/companies/create` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalCompanyCreate(props: {
