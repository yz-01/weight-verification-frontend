...
import CreateRoute from "@/app/(dashboard)/deductions/create/page";

/**
 * `/deductions/create` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalDeductionCreate() {
  return (
    <FormDialog>
      <CreateRoute />
    </FormDialog>
