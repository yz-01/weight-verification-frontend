...
import EditRoute from "@/app/(dashboard)/receipts/[id]/edit/page";

/**
 * `/receipts/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalReceiptEdit(props: PageProps<"/receipts/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
