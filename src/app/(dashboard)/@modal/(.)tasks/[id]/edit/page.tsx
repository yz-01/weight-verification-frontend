...
import EditRoute from "@/app/(dashboard)/tasks/[id]/edit/page";

/**
 * `/tasks/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalTaskEdit(props: PageProps<"/tasks/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
