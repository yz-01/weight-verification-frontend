...
import EditRoute from "@/app/(dashboard)/roles/[id]/edit/page";

/**
 * `/roles/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalRoleEdit(props: PageProps<"/roles/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
