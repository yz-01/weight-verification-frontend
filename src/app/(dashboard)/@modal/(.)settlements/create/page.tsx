...
import CreateRoute from "@/app/(dashboard)/settlements/create/page";

/**
 * `/settlements/create` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalSettlementCreate() {
  return (
    <FormDialog>
      <CreateRoute />
    </FormDialog>
