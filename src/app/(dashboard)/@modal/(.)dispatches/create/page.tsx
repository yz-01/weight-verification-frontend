...
import CreateRoute from "@/app/(dashboard)/dispatches/create/page";

/**
 * `/dispatches/create` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalDispatchCreate() {
  return (
    <FormDialog>
      <CreateRoute />
    </FormDialog>
