...
import EditRoute from "@/app/(dashboard)/dispatches/[id]/edit/page";

/**
 * `/dispatches/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalDispatchEdit(props: PageProps<"/dispatches/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
