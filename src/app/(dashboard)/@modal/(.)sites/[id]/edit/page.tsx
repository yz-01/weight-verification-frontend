...
import EditRoute from "@/app/(dashboard)/sites/[id]/edit/page";

/**
 * `/sites/[id]/edit` opened from inside the app (T-216).
 *
 ...
 */
export default function ModalSiteEdit(props: PageProps<"/sites/[id]/edit">) {
  return (
    <FormDialog>
      <EditRoute {...props} />
    </FormDialog>
